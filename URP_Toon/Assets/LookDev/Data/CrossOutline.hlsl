...
///////////////////////////////////////
////	RobertsCrossï˚éÆÇÁÇµÇ¢ 21/01/07
///////////////////////////////////////
...
{
    float halfScaleFloor = floor(OutlineThickness * 0.5); //ëΩï™thicknessÇêÆêîÇ…ä€ÇﬂÇƒÇ¢ÇÈ
	float halfScaleCeil = ceil(OutlineThickness * 0.5);	//ëΩï™thicknessÇêÆêîÇ…ä€ÇﬂÇƒÇ¢ÇÈ
